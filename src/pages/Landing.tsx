    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-amber-500 selection:text-white">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Card 6 */}
          <div className="bg-white border border-slate-200/60 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 space-y-4">
            <div className="bg-purple-50 w-12 h-12 flex items-center justify-center rounded-xl text-purple-600">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-slate-900">AI Review Assistant (Gemini)</h3>
            <p className="text-slate-500 text-sm leading-relaxed">
              Supervisors receive automated proposal quality scores and actionable review insights powered by Google Gemini integration.
            </p>
          </div>
